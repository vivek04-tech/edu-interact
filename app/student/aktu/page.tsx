...
export default function AKTUCoursesPage() {
  const courses = [
    { id: 1, name: 'Mathematics I', semester: 1, duration: '8 weeks', enrolled: true, progress: 65 },
    { id: 2, name: 'Physics Fundamentals', semester: 1, duration: '8 weeks', enrolled: true, progress: 45 },
    { id: 3, name: 'Computer Programming', semester: 1, duration: '10 weeks', enrolled: false, students: 324 },
    { id: 4, name: 'Engineering Drawing', semester: 2, duration: '6 weeks', enrolled: false, students: 198 },
    { id: 5, name: 'Digital Electronics', semester: 3, duration: '8 weeks', enrolled: false, students: 156 },
    { id: 6, name: 'Data Structures', semester: 3, duration: '10 weeks', enrolled: true, progress: 80 },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <PageWrapper>
          ...
          <PageSection>
            <PageHeader
              title="AKTU Affiliated Courses"
              description="Structured curriculum for AKTU students with expert instruction and real-world projects"
            />
          </PageSection>
